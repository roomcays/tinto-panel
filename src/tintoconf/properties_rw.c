...
void add_entry(char* key, char* value) {
  ...
  if (strcmp(key, "rounded") == 0) {
    ...
    // Background* bg = &g_array_index(backgrounds, Background,
    // backgrounds->len-1);
  ...
  /* Panel */
    ...
    if (value2)
      gtk_spin_button_set_value(GTK_SPIN_BUTTON(panel_padding_y), atof(value2));
    if (value3)
      gtk_spin_button_set_value(GTK_SPIN_BUTTON(panel_spacing), atof(value3));
  ...
  /* autohide options */
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(panel_autohide),
                                 atoi(value));
  } else if (strcmp(key, "autohide_show_timeout") == 0) {
    gtk_spin_button_set_value(GTK_SPIN_BUTTON(panel_autohide_show_time),
                              atof(value));
  } else if (strcmp(key, "autohide_hide_timeout") == 0) {
    gtk_spin_button_set_value(GTK_SPIN_BUTTON(panel_autohide_hide_time),
                              atof(value));
    ...
    if (atoi(value) == 0) {
      ...
      gtk_spin_button_set_value(GTK_SPIN_BUTTON(panel_autohide_size),
                                atof(value));
  }

  /* Battery */
  else if (strcmp(key, "battery_low_status") == 0) {
    gtk_spin_button_set_value(GTK_SPIN_BUTTON(battery_alert_if_lower),
                              atof(value));
    ...
    if (value2) {
      ...
      gtk_color_button_set_alpha(GTK_COLOR_BUTTON(battery_font_color),
                                 (alpha * 65535) / 100);
    }
    ...
    // int id = atoi (value);
    // id = (id < backgrounds->len && id >= 0) ? id : 0;
    // panel_config.battery.area.bg = &g_array_index(backgrounds, Background,
    // id);
    ...
    if (percentage_hide == 0)
      ...
      gtk_spin_button_set_value(GTK_SPIN_BUTTON(battery_hide_if_higher),
                                atof(value));
  }
  ...
  /* Clock */
    ...
    if (value2) {
      int alpha = atoi(value2);
      gtk_color_button_set_alpha(GTK_COLOR_BUTTON(clock_font_color),
                                 (alpha * 65535) / 100);
    }
    ...
    if (value2)
      gtk_spin_button_set_value(GTK_SPIN_BUTTON(clock_padding_y), atof(value2));
  ...
  /* Taskbar */
    ...
    if (value2)
      gtk_spin_button_set_value(GTK_SPIN_BUTTON(taskbar_padding_y),
                                atof(value2));
    if (value3)
      gtk_spin_button_set_value(GTK_SPIN_BUTTON(taskbar_spacing), atof(value3));
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(taskbar_show_name),
                                 atoi(value));
  } else if (strcmp(key, "taskbar_name_padding") == 0) {
    extract_values(value, &value1, &value2, &value3);
    gtk_spin_button_set_value(GTK_SPIN_BUTTON(taskbar_name_padding_x),
                              atof(value1));
    ...
    GdkColor col;
    hex2gdk(value1, &col);
    gtk_color_button_set_color(GTK_COLOR_BUTTON(taskbar_name_inactive_color),
                               &col);
    if (value2) {
      int alpha = atoi(value2);
      gtk_color_button_set_alpha(GTK_COLOR_BUTTON(taskbar_name_inactive_color),
                                 (alpha * 65535) / 100);
    }
    ...
    GdkColor col;
    hex2gdk(value1, &col);
    gtk_color_button_set_color(GTK_COLOR_BUTTON(taskbar_name_active_color),
                               &col);
    if (value2) {
      int alpha = atoi(value2);
      gtk_color_button_set_alpha(GTK_COLOR_BUTTON(taskbar_name_active_color),
                                 (alpha * 65535) / 100);
    }
  }
  ...
  /* Task */
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(task_show_text),
                                 atoi(value));
  } else if (strcmp(key, "task_icon") == 0) {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(task_show_icon),
                                 atoi(value));
  } else if (strcmp(key, "task_centered") == 0) {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(task_align_center),
                                 atoi(value));
  } else if (strcmp(key, "font_shadow") == 0) {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(task_font_shadow),
                                 atoi(value));
    ...
    extract_values(value, &value1, &value2, &value3);
    gtk_spin_button_set_value(GTK_SPIN_BUTTON(task_maximum_width),
                              atof(value1));
    gtk_spin_button_set_value(GTK_SPIN_BUTTON(task_maximum_height), 30.0);
    if (value2)
      gtk_spin_button_set_value(GTK_SPIN_BUTTON(task_maximum_height),
                                atof(value2));
  } else if (strcmp(key, "task_padding") == 0) {
    extract_values(value, &value1, &value2, &value3);
    gtk_spin_button_set_value(GTK_SPIN_BUTTON(task_padding_x), atof(value1));
    if (value2)
      gtk_spin_button_set_value(GTK_SPIN_BUTTON(task_padding_y), atof(value2));
    ...
    */
    ...
    int id = atoi (value);
    id = (id < backgrounds->len && id >= 0) ? id : 0;
    panel_config.g_task.background[status] = &g_array_index(backgrounds,
    Background, id);
    panel_config.g_task.config_background_mask |= (1<<status);
    if (status == TASK_NORMAL) panel_config.g_task.area.bg =
    panel_config.g_task.background[TASK_NORMAL];
    */
  }
  // "tooltip" is deprecated but here for backwards compatibility
  else if (strcmp(key, "task_tooltip") == 0 || strcmp(key, "tooltip") == 0) {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(tooltip_task_show),
                                 atoi(value));
  }
  ...
  /* Systray */
    ...
    if (value2)
      gtk_spin_button_set_value(GTK_SPIN_BUTTON(systray_padding_y),
                                atof(value2));
    if (value3)
      gtk_spin_button_set_value(GTK_SPIN_BUTTON(systray_spacing), atof(value3));
    ...
    extract_values(value, &value1, &value2, &value3);
    gtk_spin_button_set_value(GTK_SPIN_BUTTON(systray_icon_opacity),
                              atof(value1));
    gtk_spin_button_set_value(GTK_SPIN_BUTTON(systray_icon_saturation),
                              atof(value2));
    gtk_spin_button_set_value(GTK_SPIN_BUTTON(systray_icon_brightness),
                              atof(value3));
  }
  ...
  /* Launcher */
    ...
    extract_values(value, &value1, &value2, &value3);
    gtk_spin_button_set_value(GTK_SPIN_BUTTON(launcher_padding_x),
                              atof(value1));
    ...
    // int id = atoi (value);
    // id = (id < backgrounds->len && id >= 0) ? id : 0;
    // panel_config.launcher.area.bg = &g_array_index(backgrounds, Background,
    // id);
  ...
  /* Tooltip */
    ...
    if (value2) {
      int alpha = atoi(value2);
      gtk_color_button_set_alpha(GTK_COLOR_BUTTON(tooltip_font_color),
                                 (alpha * 65535) / 100);
    }
