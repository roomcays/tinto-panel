...
GtkWidget* create_properties() {
  ...
  GtkWidget* page_panel, *page_panel_items, *page_launcher, *page_taskbar,
      *page_battery, *page_clock, *page_tooltip, *page_systemtray, *page_task,
      *page_background;
  GtkWidget* label;
...
void create_panel(GtkWidget* parent) {
  ...
  gtk_table_attach(GTK_TABLE(table), panel_width, 2, 3, 0, 1, GTK_FILL, 0, 0,
                   0);

  panel_combo_width_type = gtk_combo_box_new_text();
  gtk_widget_show(panel_combo_width_type);
  gtk_table_attach(GTK_TABLE(table), panel_combo_width_type, 3, 4, 0, 1,
                   GTK_FILL, 0, 0, 0);
  gtk_combo_box_append_text(GTK_COMBO_BOX(panel_combo_width_type),
                            _("Percent"));
  ...
  gtk_table_attach(GTK_TABLE(table), panel_margin_x, 7, 8, 0, 1, GTK_FILL, 0, 0,
                   0);
  ...
  gtk_table_attach(GTK_TABLE(table), panel_height, 2, 3, 1, 2, GTK_FILL, 0, 0,
                   0);
  ...
  gtk_table_attach(GTK_TABLE(table), panel_combo_height_type, 3, 4, 1, 2,
                   GTK_FILL, 0, 0, 0);
  gtk_combo_box_append_text(GTK_COMBO_BOX(panel_combo_height_type),
                            _("Percent"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(panel_combo_height_type),
                            _("Pixels"));
  ...
  gtk_table_attach(GTK_TABLE(table), panel_margin_y, 7, 8, 1, 2, GTK_FILL, 0, 0,
                   0);
  ...
  for (i = 0; i < 12; ++i) {
    ...
    //		g_signal_connect (G_OBJECT (screen_position[i]), "button-press-event",
    //G_CALLBACK (screen_position_pressed));
    //		g_signal_connect (G_OBJECT (screen_position[i]), "key-press-event",
    //G_CALLBACK (screen_position_pressed));
  }
  ...
  gtk_table_attach(GTK_TABLE(table), panel_autohide, 3, 4, 0, 1, GTK_FILL, 0, 0,
                   0);
  ...
  gtk_table_attach(GTK_TABLE(table), panel_autohide_show_time, 7, 8, 0, 1,
                   GTK_FILL, 0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), panel_autohide_size, 3, 4, 1, 2, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), panel_autohide_hide_time, 7, 8, 1, 2,
                   GTK_FILL, 0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), panel_padding_x, 3, 4, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), combo_background, 7, 8, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), panel_padding_y, 3, 4, 1, 2, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), panel_spacing, 7, 8, 1, 2, GTK_FILL, 0, 0,
                   0);
  ...
  gtk_table_attach(GTK_TABLE(table), panel_wm_menu, 3, 4, 0, 1, GTK_FILL, 0, 0,
                   0);
  ...
  gtk_table_attach(GTK_TABLE(table), panel_combo_layer, 7, 8, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), panel_combo_strut_policy, 7, 8, 1, 2,
                   GTK_FILL, 0, 0, 0);
  gtk_combo_box_append_text(GTK_COMBO_BOX(panel_combo_strut_policy),
                            _("Follow panel size"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(panel_combo_strut_policy),
  ...
  gtk_table_attach(GTK_TABLE(table), panel_combo_monitor, 11, 12, 0, 1,
                   GTK_FILL, 0, 0, 0);
...
void create_panel_items(GtkWidget* parent) {
  ...
  gtk_table_attach(GTK_TABLE(table), items_order, 1, 2, 0, 1, GTK_FILL, 0, 0,
                   0);
...
void create_launcher(GtkWidget* parent) {
  ...
  gtk_table_attach(GTK_TABLE(table), launcher_padding_x, 3, 4, 0, 1, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), launcher_padding_y, 3, 4, 1, 2, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), launcher_spacing, 3, 4, 2, 3, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), launcher_icon_size, 7, 8, 1, 2, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), launcher_icon_theme, 7, 8, 2, 3, GTK_FILL,
                   0, 0, 0);
...
void create_taskbar(GtkWidget* parent) {
  ...
  gtk_table_attach(GTK_TABLE(table), taskbar_show_desktop, 1, 2, 0, 1, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), taskbar_show_name, 1, 2, 1, 2, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), taskbar_padding_x, 3, 4, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), taskbar_padding_y, 3, 4, 1, 2, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), taskbar_spacing, 3, 4, 2, 3, GTK_FILL, 0,
                   0, 0);
  ...
  combo_background = gtk_combo_box_new_text();
  gtk_widget_show(combo_background);
  gtk_table_attach(GTK_TABLE(table), combo_background, 7, 8, 1, 2, GTK_FILL, 0,
                   0, 0);
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 1"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 2"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 3"));
  ...
  gtk_table_attach(GTK_TABLE(table), taskbar_name_padding_x, 3, 4, 0, 1,
                   GTK_FILL, 0, 0, 0);
  ...
  gtk_color_button_set_use_alpha(GTK_COLOR_BUTTON(taskbar_name_inactive_color),
                                 TRUE);
  gtk_widget_show(taskbar_name_inactive_color);
  gtk_table_attach(GTK_TABLE(table), taskbar_name_inactive_color, 3, 4, 1, 2,
                   GTK_FILL, 0, 0, 0);
  ...
  gtk_color_button_set_use_alpha(GTK_COLOR_BUTTON(taskbar_name_active_color),
                                 TRUE);
  gtk_widget_show(taskbar_name_active_color);
  gtk_table_attach(GTK_TABLE(table), taskbar_name_active_color, 3, 4, 2, 3,
                   GTK_FILL, 0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), taskbar_name_font, 7, 22, 0, 1, GTK_FILL,
                   0, 0, 0);
  // gtk_font_button_set_show_style (GTK_FONT_BUTTON (taskbar_name_font),
  // FALSE);
  ...
  combo_background = gtk_combo_box_new_text();
  gtk_widget_show(combo_background);
  gtk_table_attach(GTK_TABLE(table), combo_background, 7, 8, 2, 3, GTK_FILL, 0,
                   0, 0);
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 1"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 2"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 3"));
...
void create_task(GtkWidget* parent) {
  ...
  gtk_table_attach(GTK_TABLE(table), task_mouse_middle, 3, 4, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_combo_box_append_text(GTK_COMBO_BOX(task_mouse_middle),
                            _("Toggle or iconify"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(task_mouse_middle),
  ...
  gtk_table_attach(GTK_TABLE(table), task_mouse_scroll_up, 7, 8, 0, 1, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_combo_box_append_text(GTK_COMBO_BOX(task_mouse_scroll_up),
                            _("Toggle or iconify"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(task_mouse_scroll_up),
                            _("Maximize or restore"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(task_mouse_scroll_up),
  ...
  gtk_table_attach(GTK_TABLE(table), task_mouse_right, 3, 4, 1, 2, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), task_mouse_scroll_down, 7, 8, 1, 2,
                   GTK_FILL, 0, 0, 0);
  ...
  gtk_combo_box_append_text(GTK_COMBO_BOX(task_mouse_scroll_down),
                            _("Iconify"));
  ...
  gtk_table_attach(GTK_TABLE(table), task_show_icon, 3, 4, 0, 1, GTK_FILL, 0, 0,
                   0);
  ...
  gtk_table_attach(GTK_TABLE(table), task_show_text, 3, 4, 1, 2, GTK_FILL, 0, 0,
                   0);
  ...
  gtk_table_attach(GTK_TABLE(table), task_align_center, 3, 4, 2, 3, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), task_font_shadow, 3, 4, 3, 4, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), task_maximum_width, 7, 8, 0, 1, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), task_maximum_height, 7, 8, 1, 2, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), task_padding_x, 7, 8, 2, 3, GTK_FILL, 0, 0,
                   0);
  ...
  gtk_table_attach(GTK_TABLE(table), task_padding_y, 7, 8, 3, 4, GTK_FILL, 0, 0,
                   0);
  ...
  gtk_table_attach(GTK_TABLE(table), task_font, 11, 12, 0, 1, GTK_FILL, 0, 0,
                   0);
...
void create_clock(GtkWidget* parent) {
  ...
  gtk_table_attach(GTK_TABLE(table), clock_format_line1, 3, 4, 0, 1, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), clock_format_line2, 3, 4, 1, 2, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), clock_tmz_line1, 7, 8, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), clock_tmz_line2, 7, 8, 1, 2, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), clock_left_command, 3, 4, 0, 1, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), clock_right_command, 7, 8, 0, 1, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), clock_padding_x, 3, 4, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), clock_padding_y, 3, 4, 1, 2, GTK_FILL, 0,
                   0, 0);
  ...
  combo_background = gtk_combo_box_new_text();
  gtk_widget_show(combo_background);
  gtk_table_attach(GTK_TABLE(table), combo_background, 3, 4, 2, 3, GTK_FILL, 0,
                   0, 0);
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 1"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 2"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 3"));
  ...
  gtk_table_attach(GTK_TABLE(table), clock_font_line1, 7, 22, 0, 1, GTK_FILL, 0,
                   0, 0);
  //	gtk_font_button_set_show_style (GTK_FONT_BUTTON (clock_font_line1),
  //FALSE);
  ...
  gtk_table_attach(GTK_TABLE(table), clock_font_line2, 7, 22, 1, 2, GTK_FILL, 0,
                   0, 0);
  //	gtk_font_button_set_show_style (GTK_FONT_BUTTON (clock_font_line2),
  //FALSE);
  ...
  gtk_table_attach(GTK_TABLE(table), clock_font_color, 7, 8, 2, 3, GTK_FILL, 0,
                   0, 0);
...
void create_systemtray(GtkWidget* parent) {
  ...
  gtk_table_attach(GTK_TABLE(table), systray_icon_order, 1, 2, 1, 2, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_combo_box_append_text(GTK_COMBO_BOX(systray_icon_order),
                            _("Left to right"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(systray_icon_order),
                            _("Right to left"));
  ...
  gtk_table_attach(GTK_TABLE(table), systray_padding_x, 3, 4, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), systray_padding_y, 3, 4, 1, 2, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), systray_spacing, 3, 4, 2, 3, GTK_FILL, 0,
                   0, 0);
  ...
  combo_background = gtk_combo_box_new_text();
  gtk_widget_show(combo_background);
  gtk_table_attach(GTK_TABLE(table), combo_background, 3, 4, 3, 4, GTK_FILL, 0,
                   0, 0);
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 1"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 2"));
  gtk_combo_box_append_text(GTK_COMBO_BOX(combo_background), _("Id 3"));
  ...
  gtk_table_attach(GTK_TABLE(table), systray_icon_size, 7, 8, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), systray_icon_opacity, 7, 8, 1, 2, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), systray_icon_saturation, 7, 8, 2, 3,
                   GTK_FILL, 0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), systray_icon_brightness, 7, 8, 3, 4,
                   GTK_FILL, 0, 0, 0);
}
...
void create_battery(GtkWidget* parent) {
  ...
  gtk_table_attach(GTK_TABLE(table), battery_hide_if_higher, 3, 4, 0, 1,
                   GTK_FILL, 0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), battery_alert_if_lower, 3, 4, 1, 2,
                   GTK_FILL, 0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), battery_alert_cmd, 8, 9, 1, 2, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), battery_padding_x, 3, 4, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), battery_padding_y, 3, 4, 1, 2, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), battery_font_line1, 7, 22, 0, 1, GTK_FILL,
                   0, 0, 0);
  //	gtk_font_button_set_show_style (GTK_FONT_BUTTON (battery_font_line1),
  //FALSE);
  ...
  gtk_table_attach(GTK_TABLE(table), battery_font_line2, 7, 22, 1, 2, GTK_FILL,
                   0, 0, 0);
  //	gtk_font_button_set_show_style (GTK_FONT_BUTTON (battery_font_line2),
  //FALSE);
  ...
  gtk_table_attach(GTK_TABLE(table), battery_font_color, 7, 8, 2, 3, GTK_FILL,
                   0, 0, 0);
...
void create_tooltip(GtkWidget* parent) {
  ...
  gtk_table_attach(GTK_TABLE(table), tooltip_task_show, 1, 2, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), tooltip_show_after, 3, 4, 0, 1, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), tooltip_hide_after, 3, 4, 1, 2, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), tooltip_padding_x, 3, 4, 0, 1, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), tooltip_padding_y, 3, 4, 1, 2, GTK_FILL, 0,
                   0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), tooltip_font, 7, 22, 0, 1, GTK_FILL, 0, 0,
                   0);
  ...
  gtk_table_attach(GTK_TABLE(table), tooltip_font_color, 7, 8, 1, 2, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), clock_format_tooltip, 3, 4, 0, 1, GTK_FILL,
                   0, 0, 0);
  ...
  gtk_table_attach(GTK_TABLE(table), clock_tmz_tooltip, 3, 4, 1, 2, GTK_FILL, 0,
                   0, 0);

  change_paragraph(parent);
}

void create_background(GtkWidget* parent) { change_paragraph(parent); }
